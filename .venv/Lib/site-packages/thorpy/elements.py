...
class DropDownListButton(Button):
    ...
    ***Optional arguments***
    ...
    def __init__(self, choices, title=None, style_normal=None, generate_surfaces=True,
                    ...
                    all_same_width=True, style_hover = None, style_pressed = None, style_locked = None):
        if title is None:
            title = choices[0]
        Button.__init__(self, title, style_normal=style_normal, style_hover=style_hover,style_pressed=style_pressed, style_locked=style_locked, generate_surfaces=generate_surfaces)
        ...
        self.ddl = DropDownList(self, choices, choice_mode, bck_func, overwrite_choices,
                                size_limit, generate_shadow, align, gap, all_same_width, style_normal, style_hover, style_pressed)
...
class TextAndImageButton(Button):
    ...
    ***Optional arguments***
    ...
    def __init__(self, text, img, mode="h", reverse=False, cls=Button, margins=(5,5), styleNormal=None, styleHover=None, stylePressed=None, text_style=None):
        if text_style is None:
            ...
            e1 = Button(text, style_normal=text_style, style_hover=text_style, style_pressed=text_style)
        #
        e2 = Image(img)
        if reverse:
            children = [e2,e1]
            ...
            children = [e1,e2]
        super().__init__(text="", children=children, style_normal=styleNormal, style_hover=styleHover, style_pressed=stylePressed)
        if mode is not None:
...
class Checkbox(ToggleButton):
    ...
    ***Optional arguments***
    ...
    def __init__(self, value=False, size="auto", style_normal=None, style_hover=None, style_pressed=None, generate_surfaces=True):
        ToggleButton.__init__(self, "", value=value, style_normal=style_normal, style_hover=style_hover, style_pressed=style_pressed, generate_surfaces=False)
        if size == "auto":
...
class DropDownList(Box):
    ...
    ***Optional arguments***
    ...
    def __init__(self, launcher, choices, choice_mode="v", bck_func=None,
                ...
                align=None, gap=5, all_same_width=True, style_normal=None, style_hover=None, style_pressed=None):
        if size_limit == "auto":
            size_limit = ("auto",)*2
        self.choice = None
        self.choice_element = None
        ...
        for e in choices:
            if isinstance(e, str): #then e is the text of the choice
                b = _DropDownButton(e, style_normal, style_hover, style_pressed)
                b.at_unclick = choice
